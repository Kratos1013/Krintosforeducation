...
import com.krintos.krintos.app.AppController;
...
public class RegisterActivity extends Activity {
     ...
     * phone and  password) to register url
     * */
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        db.addUser(username, phone, uid, created_at);

                        Toast.makeText(getApplicationContext(), "Welcome to Krintos!", Toast.LENGTH_LONG).show();

                        if(!error){session.setLogin(true);
